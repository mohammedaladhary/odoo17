...
class MeqRequest(models.Model):
    ...
    dept_id = fields.Many2one('hr.department', 'Department', default=lambda self: self.env.user)
    ...
    description = fields.Html('Item Description', required=True)
    ...
    def action_submit(self):
        ...
        self.state = 'submit'
        self.name = self.env['ir.sequence'].next_by_code('item.request') or _('New')
