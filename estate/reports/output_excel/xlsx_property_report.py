...
class XlsxPropertyReport(http.Controller):
    ...
    def download_property_excel_report(self, property_ids):
        ...
        property_ids = request.env['estate.property.tag'].browse(literal_eval(property_ids))
        output = io.BytesIO()
        ...
        headers = ['Name','Color Index Override Field']
        ...
        for property in property_ids:
            ...
            worksheet.write(row_num, 1, property.color, string_format)
